...
import { ChakraProvider, Heading, useToast, Box, Button, HStack, Spacer,Image } from '@chakra-ui/react';
...
function Header() {
  ...
  return(
    ...
    <HStack>
      ...
      objectFit="cover"
      alignItems="center" 
      src={'https://d33wubrfki0l68.cloudfront.net/6cc043f2cb1fa1b90cf3ae518f2d6b18bfbe2f4a/b22b3/static/hero-anim-token-1b2270fa949ba9dfbd9fcd8ec83da71b.png'}
      borderRadius='lg'
    />
    ...
    <Box>
    <Button  variant='solid' colorScheme='pink' borderRadius="30px" onClick={extensionaccount}>
